...
<template>
  <TransitionRoot appear :show="customerStore.isModalOpen" as="template">
    <Dialog as="div" class="relative z-10">
      ...
      <div class="fixed inset-0 flex items-center justify-center">
        <DialogPanel class="w-full min-h-xl max-w-xl bg-[#D3D3D3] p-8 rounded-lg shadow-lg overflow-y-auto h-full">
  ...
  <div>
    ...
    />
    <div 
    v-if="customerStore.errors.code" 
  ...
  <div>
    ...
    />
            ...
            <div class="flex justify-end space-x-2">
              ...
              <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded cursor-pointer">Zapisz</button>
            </div>
          </form>
        </DialogPanel>
      </div>
