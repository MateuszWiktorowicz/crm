      ...
      <table class="w-full border-separate border-spacing-0">
        <thead class="bg-gray-100 sticky top-0 z-10">
          <tr class="bg-gray-100 text-gray-700 uppercase text-sm leading-normal rounded-t-lg">
            ...
            <th class="border border-gray-300 p-3 text-left">Klient</th>
            <th class="border border-gray-300 p-3 text-left">Pracownik</th>
            ...
            <th class="border border-gray-300 p-3 text-left">Data stworzenia</th>
